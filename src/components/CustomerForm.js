...
class CustomerForm extends React.Component {
  ...
  render() {
    ...
    if (!selections.location || !selections.service || !selections.employee || !selections.date || !selections.time) return null //customer form appears only after location, service and employee is selected
    return (
