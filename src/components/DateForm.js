...
class DateForm extends React.Component {
  ...
  getDisabledDates = (dates) => {
    ...
    for (let numberDateIx=0;numberDateIx<numberDates.length-1;numberDateIx++) {
      ...
      if (numberDates[numberDateIx]!==(numberDates[numberDateIx+1]-1)) {
        ...
        for (let startDate=numberDates[numberDateIx]+1;
                 startDate<numberDates[numberDateIx+1];startDate++) {
          const strDate=startDate.toString()
          const strDateYYYYMMDD = strDate.substr(0,4)+'-'+
                                  strDate.substr(4,2)+'-'+
                                  strDate.substr(6,2)
    ...
    return (
       <div className = "calendarFrame">
           ...
           <Calendar
              ...
              minDate={new Date(dates[0].substr(0,4),
              ...
              maxDate={new Date(dates[dates.length - 1].substr(0,4),
